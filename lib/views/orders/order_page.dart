...
class OrderPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int totalPrice = orderRequest.grandTotal;
                ...
                child: Column(
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RowText(
                              first: 'Order Total',
                              second:
                                  '\$ ${orderRequest.orderTotal.toStringAsFixed(2)}'),
                          SizedBox(
                            height: 5.h,
                          ),
                          RowText(
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                ...
                                itemCount:
                                    orderRequest.orderItems[0].additives.length,
                                itemBuilder: (context, i) {
                                  String additive =
                                      orderRequest.orderItems[0].additives[i];
                                  return Container(
                    ...
                    CustomButton(
                      ...
                      btnHeight: 45,
                      onTap: () {
                        String orderData = orderRequestToJson(orderRequest);
                        controller.createOrder(orderData, orderRequest);
                      },
                    )
                  ],
                ),
